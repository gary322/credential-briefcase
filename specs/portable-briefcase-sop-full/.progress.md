...
- **Phase**: implement
- **Task**: Phase 11.3 Optional remote custody mode (HSM/Vault)
- **Status**: pending
...
1. Phase 11.3: Optional remote custody mode (remote signer backend + control plane signing service).
2. Phase 12.1: Fuzzing + security regression suite.
3. Phase 12.2: Observability (OpenTelemetry end-to-end).
