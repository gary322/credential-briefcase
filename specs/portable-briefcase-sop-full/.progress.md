...
- **Phase**: implement
- **Task**: Phase 9.1 OAuth revoke/forget flows
- **Status**: pending
...
1. Phase 9.1: OAuth revoke/forget flows.
2. Phase 9.2: VC status list verification.
3. Phase 9.3: Capability revocation profile.
