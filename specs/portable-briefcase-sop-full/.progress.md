...
- **Phase**: implement
- **Task**: Phase 11.2 Integrate device enrollment and policy sync into daemon
- **Status**: pending
...
1. Phase 9.3: Capability revocation profile.
2. Phase 10.1: Define AI interface and “non-authoritative” invariants.
3. Phase 10.2: Implement policy compiler (proposal + diff + apply).
