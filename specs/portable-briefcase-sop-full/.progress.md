...
- **Phase**: complete
- **Task**: All phases (0-12) implemented
- **Status**: done
...
- Phase 12.2: OpenTelemetry traces + metrics + end-to-end trace assertion
- Phase 12.3: Release automation for extension/mobile/container + SBOMs
...
1. Bump versions and push a tag `vX.Y.Z` (next: `v0.1.5`) to validate release assets in GitHub Actions.
