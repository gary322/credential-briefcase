...
- **Phase**: implement
- **Task**: Phase 12.1 Add fuzzing + security regression suite
- **Status**: pending
...
1. Phase 12.1: Fuzzing + security regression suite.
2. Phase 12.2: Observability (OpenTelemetry end-to-end).
3. Phase 12.3: Release automation for multi-artifact repo.
