...
- **Phase**: implement
- **Task**: Phase 4.2 PKCS#11 backend (SoftHSM)
- **Status**: pending
...
1. Phase 4.2: PKCS#11 signer backend with SoftHSM CI.
2. Phase 4.3: TPM2 signer backend with swtpm CI.
3. Phase 4.4: Apple Keychain/Secure Enclave backend.
